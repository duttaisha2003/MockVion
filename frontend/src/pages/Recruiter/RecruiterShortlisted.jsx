...
const RecruiterShortlisted = () => {
  ...
  const handleOpenApplicants = (jobId) => {console.log("bye",jobId)
    navigate(`/recruiter/job/shortlisted/${jobId}`);
  };

  return (
    <div className="min-h-screen max-w-6xl mx-auto bg-transparent text-white p-8">
      <h1 className="text-3xl font-bold mb-2">View All Jobs and Shortlisted Candidates</h1>

      <p className="text-gray-400 mb-8">
        See all jobs and how many candidates Shortlisted
      </p>
